/**
 * @file at24cxx.h
 * @brief Minimal AT24CXX declarations for CI package backend compile smoke.
 */
#ifndef AUTOGEN_PM_CI_AT24CXX_H
#define AUTOGEN_PM_CI_AT24CXX_H
...
/** @brief RT-Thread boolean stub used by the package compile smoke. */
typedef int rt_bool_t;
/** @brief AT24CXX opaque device stub used by the package compile smoke. */
typedef struct autogen_pm_ci_at24_device *at24cxx_device_t;
...
#endif /* !defined(AUTOGEN_PM_CI_AT24CXX_H) */
