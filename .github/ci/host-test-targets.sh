...
PYMANIFEST
            ...
            ;;
        par_generated_runtime_condition_disabled)
            rm -rf "$build_dir/generated-runtime-condition-disabled"
            mkdir -p "$build_dir/generated-runtime-condition-disabled/out"
            python3 - "$build_dir/generated-runtime-condition-disabled/par_table.generated-runtime.csv" <<'PYGEN_COND'
from pathlib import Path
import csv
import sys
...
rows = [
    ...
    ["GEN", "Object", "", "ePAR_GEN_NAME", "3", "STR", "Gen Name", "0", "8", "ap", "", "RW", "ALL", "ALL", "0", "Generated string object.", ""],
    ["GEN", "Object", "(1 == PAR_CFG_ENABLE_TYPE_BYTES)", "ePAR_GEN_KEY", "4", "BYTES", "Gen Key", "0", "4", "0x01,0x02,0x03", "", "RW", "ALL", "ALL", "0", "Generated bytes object.", ""],
    ["GEN", "Object", "(1 == PAR_CFG_ENABLE_TYPE_ARR_U8)", "ePAR_GEN_SKIP8", "5", "ARR_U8", "Gen Skip8", "3", "3", "1,2,3", "", "RW", "ALL", "ALL", "0", "Generated disabled U8 array object.", ""],
    ["GEN", "Object", "(1 == PAR_CFG_ENABLE_TYPE_ARR_U16)", "ePAR_GEN_ARR16", "6", "ARR_U16", "Gen Arr16", "2", "2", "10,20", "", "RW", "ALL", "ALL", "0", "Generated U16 array object.", ""],
]
...
PYGEN_COND
            cp parameters/schema/par_id_lock.json \
                "$build_dir/generated-runtime-condition-disabled/par_id_lock.json"
            python3 parameters/tools/pargen.py \
                --csv "$build_dir/generated-runtime-condition-disabled/par_table.generated-runtime.csv" \
                --id-lock "$build_dir/generated-runtime-condition-disabled/par_id_lock.json" \
                --config parameters/schema/pargen.json \
                --out-def "$build_dir/generated-runtime-condition-disabled/par_table.def" \
                --out-dir "$build_dir/generated-runtime-condition-disabled/out" \
                --manifest "$build_dir/generated-runtime-condition-disabled/par_manifest.json"
            echo "[host-tests] build par_generated_runtime_condition_disabled"
            gcc -I"$build_dir/generated-runtime-condition-disabled" \
                -I"$build_dir/generated-runtime-condition-disabled/out" \
                "${common_cflags[@]}" \
                "${autogen_pm_ci_defines[@]}" \
                ...
                -DPAR_CFG_LAYOUT_SOURCE=PAR_CFG_LAYOUT_SCRIPT \
                parameters/tests/host/test_par_generated_runtime_consistency.c \
                "$build_dir/generated-runtime-condition-disabled/out/par_layout_static.c" \
                "$build_dir/generated-runtime-condition-disabled/out/par_generated_info.c" \
                "${base_sources[@]}" \
                -o "$build_dir/par_generated_runtime_condition_disabled"
            echo "[host-tests] run par_generated_runtime_condition_disabled"
            "$build_dir/par_generated_runtime_condition_disabled"
            ;;
        par_generated_runtime_scalar_only)
