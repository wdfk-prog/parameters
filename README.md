...
- Unchecked setter APIs skip runtime validation callbacks and on-change callbacks, so they should be reserved for tightly controlled hot paths. Legacy `*_fast()` names remain as deprecated aliases.
