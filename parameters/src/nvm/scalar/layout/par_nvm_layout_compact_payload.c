...
#define PAR_NVM_LAYOUT_COMPACT_PAYLOAD_OBJECT_NOP(...)
typedef struct
{
    uint8_t base__[PAR_NVM_LAYOUT_COMPACT_PAYLOAD_OFFSET_MAP_BASE_SIZE];
#define PAR_ITEM_U8(...)  PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_1)
#define PAR_ITEM_U16(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_2)
#define PAR_ITEM_U32(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_4)
#define PAR_ITEM_I8(...)  PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_1)
#define PAR_ITEM_I16(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_2)
#define PAR_ITEM_I32(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_4)
#define PAR_ITEM_F32(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_PERSIST_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__), PAR_NVM_LAYOUT_COMPACT_PAYLOAD_MEMBER_4)
#define PAR_OBJECT_ITEM_ENABLED_HANDLER  PAR_NVM_LAYOUT_COMPACT_PAYLOAD_OBJECT_NOP
#define PAR_OBJECT_ITEM_DISABLED_HANDLER PAR_NVM_LAYOUT_COMPACT_PAYLOAD_OBJECT_NOP
...
#define PAR_ITEM_I8(...)  PAR_NVM_LAYOUT_COMPACT_PAYLOAD_ADDR_ENTRY_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__))
#define PAR_ITEM_I16(...) PAR_NVM_LAYOUT_COMPACT_PAYLOAD_ADDR_ENTRY_SELECT(PAR_XARG_ENUM(__VA_ARGS__), PAR_XARG_PERS(__VA_ARGS__))
...
#undef PAR_NVM_LAYOUT_COMPACT_PAYLOAD_OBJECT_NOP
