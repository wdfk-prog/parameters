...
#error "PAR_LAYOUT_STATIC_COUNTOBJ must be provided by static layout include!"
#endif /* !defined(PAR_LAYOUT_STATIC_COUNTOBJ) */
#ifndef PAR_LAYOUT_STATIC_OBJ_POOL_BYTES
#error "PAR_LAYOUT_STATIC_OBJ_POOL_BYTES must be provided by static layout include!"
#endif /* !defined(PAR_LAYOUT_STATIC_OBJ_POOL_BYTES) */

/**
 * @brief Object storage slot count from generated static layout.
 *
 * PAR_LAYOUT_COMPILE_COUNTOBJ is an enum constant, so it must not be used in
 * preprocessor #if expressions.
 */
#define PAR_STORAGE_COUNTOBJ       (PAR_LAYOUT_STATIC_COUNTOBJ)

/**
 * @brief Object storage pool size in bytes from generated static layout.
 */
#define PAR_STORAGE_OBJ_POOL_BYTES (PAR_LAYOUT_STATIC_OBJ_POOL_BYTES)

PAR_STATIC_ASSERT(par_layout_static_count_obj_matches_table,
                  (PAR_STORAGE_COUNTOBJ == PAR_LAYOUT_COMPILE_COUNTOBJ));
PAR_STATIC_ASSERT(par_layout_static_obj_pool_bytes_matches_table,
                  (PAR_STORAGE_OBJ_POOL_BYTES == PAR_LAYOUT_COMPILE_OBJ_POOL_BYTES));
#else
