...
/**
*@file      par_layout.c
*@brief     Parameter storage layout abstraction implementation
*@author    wdfk-prog
...
/**
 *  Runtime-generated offset table.
 *
 * @note  Offsets are generated with a plain runtime scan loop instead of macro
 *        expansion to keep the mapping logic readable and easy to debug.
 * @note  When PAR_CFG_LAYOUT_SOURCE is PAR_CFG_LAYOUT_SCRIPT, runtime fill is
 *        compile-time disabled and PAR_LAYOUT_STATIC_OFFSET_TABLE is consumed
 *        directly, avoiding extra maintenance complexity.
 */
...
////////////////////////////////////////////////////////////////////////////////
/**
*        Initialize active parameter layout source
*
...
////////////////////////////////////////////////////////////////////////////////
/**
*        Get active offset table pointer
*
* @return       p_table - Pointer to active offset table
*/
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/**
*        Get offset by parameter number
*
* @param[in]    par_num - Parameter number (enumeration)
* @return       offset  - Offset inside type group storage
*/
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/**
*        Get per-width layout counts
*
* @return       count - Number of 8/16/32-bit parameters
*/
////////////////////////////////////////////////////////////////////////////////
